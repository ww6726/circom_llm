...
// load src
Fr_sub(&expaux[0],&circuitConstants[0],&signalValues[mySignalStart + 2]); // line circom 100
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_mul(&expaux[0],&signalValues[mySignalStart + 3],&circuitConstants[1]); // line circom 101
{
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 1],&signalValues[mySignalStart + 2]); // line circom 103
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
